...
from .models import DataStructures,Plateforms,ProgrammingLanguages,Problems,problems_plateforms,problems_datastructures,Solutions,solutions_datastructures
# from .models import problems_detailssets
